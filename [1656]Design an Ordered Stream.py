...
#  
#  Related Topics Array Hash Table Design Data Stream 👍 213 👎 1772
...
class OrderedStream:
    ...
    def insert(self, idKey: int, value: str) -> List[str]:
        ...
        final = []
        while self.cache[self.current]:
            final.append(self.cache[self.current])
            self.cache[self.current] = None
            self.current += 1
        return final
