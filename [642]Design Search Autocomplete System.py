...
# except '#', return the top 3 historical hot sentences that have the same prefix as 
...
# is the hottest one). If several sentences have the same hot degree, use ASCII-
...
# , "i love leetcode" should be in front of "ironman". Also we only need to 
...
#  
#  Related Topics String Design Trie Data Stream 👍 1790 👎 121
